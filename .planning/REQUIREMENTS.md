...
*Last updated: 2026-09-08 after plan 10-04 (IDENT-01 and IDENT-02 closed by the CRT and glitch treatment: four layers behind one attribute on <html>, seven source scans in src/lib/ui/aesthetic.spec.ts holding the scoping, and the reduced-motion claim asserted at the COMPOSITOR in both browser projects rather than on a canvas backing store that a CSS overlay never touches. Both rows carry their qualifiers in full. Phase 10 amended SAFE-01, CONN-03 and PREV-03 by name and date in plan 10-03; the hardware halves of SAFE-02 to SAFE-06 and Phase 6 rows A to F remain presented and unanswered - no agent has written a byte to a real ZONA)*
