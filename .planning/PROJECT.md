...
---
*Last updated: 2026-09-04 after Phase 8 (New Configurations) — seven Lua-authored instruments in the catalog behind a proven Lua host, laziness proven on the production build, hardware audition pending the user; Phase 5 (tuning, budgets, sharing) in planning*
