...
---
*Last updated: 2026-09-04 after Phase 4 (First Experience) — splash dissolves into a live coverflow, choose reveals TRY ON DEVICE (connect + identify, never writes), eight prerendered config addresses, deployed to the gated preview; Phase 8's catalog module and Lua-host plan underway*
