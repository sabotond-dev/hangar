...
- [ ] **Phase 9: Twenty Configurations** - The catalog goes from sixteen entries to thirty-six, each one useful to a named person in a named application (in progress; 2 of 10 plans complete as of 2026-09-07 — the baselines measured and reconciled, the host-surface gate closing the trap-scanner gap, the knob sweep out of the quick run, and the browse literals, the copy gate and the output gate made ready for twenty new entries)
