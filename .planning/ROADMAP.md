...
- [ ] **Phase 9: Twenty Configurations** - The catalog goes from sixteen entries to thirty-six, each one useful to a named person in a named application (in progress; 4 of 10 plans complete as of 2026-09-07 — the baselines and the host-surface gate, the browse literals and the copy gate, and two entry waves: HOLD, STEPS and SLAM, then KEYS, GRIDLOCK and TABLE, at twenty-two entries)
